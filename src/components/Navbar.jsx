    ...
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 ">
        <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
            ...
            <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                <a className="font-medium text-primary" href="recipes" aria-current="page">Recipes</a>
                <a className="font-medium text-gray-600 hover:text-gray-400 " href="#">About</a>
                <a className="font-medium text-gray-600 hover:text-gray-400 " href="#">Work</a>
                <a className="font-medium text-gray-600 hover:text-gray-400 " href="blog">Blog</a>
            </div>
            </div>
        </nav>
    </header>
