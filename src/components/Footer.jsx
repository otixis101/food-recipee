...
const Footer = () => {
  return (
    <footer class="w-full max-w-[85rem] py-10 px-8 sm:px-6 lg:px-8 mx-auto">
  
        <div class="text-center">
            <div>
            <a class="flex-none text-xl font-semibold text-alternate" href="#" aria-label="Brand">Recipee</a>
            </div>
            

            <div class="mt-3">
            <p class="text-gray-500 text-lg">This is for my school project.</p>
